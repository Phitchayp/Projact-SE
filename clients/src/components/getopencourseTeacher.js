        ...
        <div>
            {A.map((course) => (
                <div key={course.courseid} className='Course-Items-open'>
                    ...
                    <div className='checkbox-text'style={{marginLeft: '20px'}}>{` ${course.term}`}</div>
                    <div className='checkbox-text'style={{ marginLeft: '20px' }}>{` ${course.course_year}`}</div>
                    <div className='checkbox-text' style={{ marginLeft: '20px' }}>{`${course.subject_id} `}</div>
